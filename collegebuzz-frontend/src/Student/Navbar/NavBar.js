...
const pages = ['Article', 'Events', 'News'];
const settings = ['Profile', 'Account', 'Dashboard', 'Logout'];
const link = ['/student/article','/','/studentnews'];
    ...
    <AppBar position="fixed" color='primary' >
      ...
      <Container maxWidth="xl" sx={{backgroundColor:'#121212', overflow:'hidden'}}>
        <Toolbar disableGutters>
          ...
          <img src={logo} style={{ display: { xs: 'none', md: 'flex' }, mr: 1 }}/>
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          {/* <img src={logo} style={{ display: { xs: 'flex', md: 'none' }, mr: 1 }}/> */}
